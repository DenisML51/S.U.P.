...
general_items_data = [
    ...
    { "name": "Аптечка", "item_type": "general", "category": "Простое", "rarity": "Обычная", "weight": 3, "description": "Содержит бинты, антисептики, базовые инструменты.", "effect": "Позволяет совершать проверки Медицины для стабилизации (Первая Помощь) или лечения ран (восстанавливает 1к8 + Медицина ПЗ, требует Действия).", "uses": 3 },
    { "name": "Медпак", "item_type": "general", "category": "Простое", "rarity": "Обычная", "weight": 3, "description": "Более крупная аптечка.", "effect": "Позволяет совершать проверки Медицины для стабилизации (Первая Помощь) или лечения ран (восстанавливает 1к8 + Медицина ПЗ, требует Действия).", "uses": 5 },
    { "name": "Стимулятор (Стим)", "item_type": "general", "category": "Простое", "rarity": "Необычная", "weight": 0.1, "description": "Инъектор с бодрящим веществом.", "effect": "Использование (Бонусное Действие) дает 2к4 временных ПЗ на 1 минуту или снимает 1 уровень Истощения. Возможны побочные эффекты (проверка Выносливости).", "uses": 1 },
