...
const getRarityColor = (rarity) => {
    switch (rarity?.toLowerCase()) {
        ...
        case 'редкая':
            return '#2196F3'; // Синий
        case 'очень редкая':
            return theme.colors.primary || '#BB86FC'; // Фиолетовый
        case 'экзотика':
            return theme.colors.warning || '#FFA726'; // Оранжевый
        case 'легендарная':
            return '#FF7043'; // Коралловый/Оранжево-красный
        case 'обычная':
        default:
...
const WeightIcon = () => (<svg style={styles.detailTagIcon} viewBox="0 0 24 24" fill="currentColor">
    <path
        d="M12 3C7.03 3 3 7.03 3 12s4.03 9 9 9 9-4.03 9-9-4.03-9-9-9zm0 16c-3.86 0-7-3.14-7-7s3.14-7 7-7 7 3.14 7 7-3.14 7-7 7zm-1-8h2v3h-2zm0-4h2v2h-2z"/>
</svg>);
const RangeIcon = () => (<svg style={styles.detailTagIcon} viewBox="0 0 24 24" fill="currentColor">
    <path
        d="M12 8c-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4zm8.94 3c-.46-4.17-3.77-7.48-7.94-7.94V1h-2v2.06C6.83 3.52 3.52 6.83 3.06 11H1v2h2.06c.46 4.17 3.77 7.48 7.94 7.94V23h2v-2.06c4.17-.46 7.48-3.77 7.94-7.94H23v-2h-2.06zM12 18c-3.31 0-6-2.69-6-6s2.69-6 6-6 6 2.69 6 6-2.69 6-6 6z"/>
</svg>);
const StrengthReqIcon = () => (<svg style={styles.detailTagIcon} viewBox="0 0 24 24" fill="currentColor">
    <path
        d="M19.5 12.5c-1.38 0-2.5 1.12-2.5 2.5s1.12 2.5 2.5 2.5 2.5-1.12 2.5-2.5-1.12-2.5-2.5-2.5zM12 19c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zm-7.5-7C3.12 12 2 13.12 2 14.5S3.12 17 4.5 17s2.5-1.12 2.5-2.5-1.12-2.5-2.5-2.5zM12 1C8.13 1 5 4.13 5 8c0 1.44.48 2.77 1.29 3.88L12 20l5.71-8.12C18.52 10.77 19 9.44 19 8c0-3.87-3.13-7-7-7z"/>
</svg>);
const StealthDisIcon = () => (<svg style={styles.detailTagIcon} viewBox="0 0 24 24" fill="currentColor">
    <path
        d="M12 4.5C7 4.5 2.73 7.61 1 12c1.73 4.39 6 7.5 11 7.5s9.27-3.11 11-7.5c-1.73-4.39-6-7.5-11-7.5zM12 17c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5zm0-8c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3 3z"/>
</svg>);
const HandIcon = () => (<svg style={styles.detailTagIcon} viewBox="0 0 24 24" fill="currentColor">
    <path
...
const UsesIcon = () => (<svg style={styles.detailTagIcon} viewBox="0 0 24 24" fill="currentColor">
    <path d="M17 4h-3V2h-4v2H7c-1.1 0-2 .9-2 2v15c0 1.1.9 2 2 2h10c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 17H7V6h10v15z"/>
    <path d="M9 11h6v2H9zm0 4h6v2H9z"/>
</svg>);
const StackIcon = () => (<svg style={styles.detailTagIcon} viewBox="0 0 24 24" fill="currentColor">
    <path d="M3 13h2v-2H3v2zm0 4h2v-2H3v2zm0-8h2V7H3v2zm4 4h14v-2H7v2zm0 4h14v-2H7v2zm0-8h14V7H7v2z"/>
</svg>);
const SkillBonusIcon = () => (<svg style={styles.detailTagIcon} viewBox="0 0 24 24" fill="currentColor">
    <path
        d="M16.23 18 20.71 12l-4.48-6H3v12h13.23zm-1.71-2H5V8h9.52l3 4-3 4zM11 11h2v2h-2v-2zm4 0h2v2h-2v-2zm-8 0h2v2H7v-2z"/>
</svg>); // Иконка "звездочки"

// Иконки для основных статов
const DamageIcon = () => (<svg style={styles.mainDetailIcon} viewBox="0 0 24 24" fill="currentColor">
    <path
        d="M19.78 2.22a.75.75 0 0 0-1.06 0l-2.22 2.22-1.41-1.41a.75.75 0 0 0-1.06 1.06l1.41 1.41-1.94 1.94-1.41-1.41a.75.75 0 0 0-1.06 1.06l1.41 1.41-1.94 1.94-1.41-1.41a.75.75 0 0 0-1.06 1.06l1.41 1.41L4 15.06V19a1 1 0 0 0 1 1h3.94l10.84-10.84L19.78 3.28a.75.75 0 0 0 0-1.06zM8.5 18H6v-2.5l7.37-7.37 2.5 2.5L8.5 18z"/>
</svg>);
const ACIcon = () => (<svg style={styles.mainDetailIcon} viewBox="0 0 24 24" fill="currentColor">
    <path
        d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm0 10.99h7c-.53 4.12-3.28 7.79-7 8.94V12H5V6.3l7-3.11v8.8z"/>
</svg>);
const EffectIcon = () => (<svg style={styles.mainDetailIcon} viewBox="0 0 24 24" fill="currentColor">
    <path
        d="M18 14.45V11c0-1.66-1.34-3-3-3 .35-.6.5-1.28.5-2 0-2.21-1.79-4-4-4S7.5 3.79 7.5 6c0 .72.15 1.4.5 2-1.66 0-3 1.34-3 3v3.45c-1.17.69-2 1.97-2 3.43V20h5v-2H6v-2.12c0-1.09.6-2.06 1.5-2.55V11c0-.83.67-1.5 1.5-1.5s1.5.67 1.5 1.5v2.76c1.17.69 2 1.97 2 3.43V20h5v-2h-2v-2.12c0-1.46-.83-2.74-2-3.43zm-6-7c0-1.1.9-2 2-2s2 .9 2 2-.9 2-2 2-2-.9-2-2z"/>
</svg>);
const FormulaIcon = () => (<svg style={styles.mainDetailIcon} viewBox="0 0 24 24" fill="currentColor">
    <path
        d="M22.7 19l-9.1-9.1c.9-2.3.4-5-1.5-6.9-2-2-5-2.4-7.4-1.5L9 6 6 9 1.6 4.7C.7 7.1 1.1 10.1 3.1 12.1c1.9 1.9 4.6 2.4 6.9 1.5l9.1 9.1c.4.4 1 .4 1.4 0l2.3-2.3c.4-.4.4-1.1 0-1.4z"/>
</svg>);

// Иконки для кнопок действий
const EquipIcon = () => (<svg style={styles.actionIcon} viewBox="0 0 24 24">
    <path
        d="M10.94 2.94A1.5 1.5 0 0 0 9.5 4.06V11H4a1 1 0 0 0-1 1v2a1 1 0 0 0 1 1h5.5v6.94a1.5 1.5 0 0 0 2.12 1.32l10-5a1.5 1.5 0 0 0 0-2.64l-10-5a1.5 1.5 0 0 0-1.18-.1z"/>
</svg>);
const UnequipIcon = () => (<svg style={styles.actionIcon} viewBox="0 0 24 24">
    <path
        d="M21.41 11.58l-9-9C12.05 2.22 11.55 2 11 2H4c-1.1 0-2 .9-2 2v7c0 .55.22 1.05.59 1.42l9 9c.36.36.86.58 1.41.58s1.05-.22 1.41-.59l7-7c.37-.36.59-.86.59-1.41s-.22-1.05-.59-1.42zM5.5 7C4.67 7 4 6.33 4 5.5S4.67 4 5.5 4 7 4.67 7 5.5 6.33 7 5.5 7z"/>
</svg>);
const UseIcon = () => (<svg style={styles.actionIcon} viewBox="0 0 24 24">
    <path
        d="M11 20a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1v-3H3a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1h2V3a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v3h8a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1h-8v6zm0-12h8V8h-8v4zM7 8v8h2v-8H7z"/>
</svg>);
const DropIcon = () => (<svg style={styles.actionIcon} viewBox="0 0 24 24">
        ...
        if (onDrop) {
            ...
            if (quantity > 1) {
                ...
                if (!isNaN(num) && num > 0 && num <= quantity) {
                    ...
                    alert(`Максимум ${quantity}. Будет выброшено ${quantity}.`);
                    quantityToDrop = quantity;
                } else {
                    alert("Некорректно. Будет выброшен 1.");
                    quantityToDrop = 1;
                }
            }
    ...
    return (
        <div style={cardStyle} title={item.description || item.name} className="item-card">
                ...
                {hasTags && (
                    <div style={styles.tagsContainer}>
                        ...
                        {skillBonusTags && skillBonusTags.map((tagText, index) => (
                            <span key={`skill-bonus-${index}`} style={{...styles.detailTag, ...styles.skillBonusTag}}
                                  title="Бонус к навыку">
            ...
            <div style={styles.actionsContainer}>
                {isActivatable && handleApiAction && (<button onClick={handleActivateClick} style={styles.actionButton}
                                                              className="action-button use-button" title="Использовать">
                    <UseIcon/></button>)}
                {isEquippable && (onEquip || onUnequip) && (
                    <button onClick={handleEquipToggleClick} style={styles.actionButton}
                            className={`action-button ${isEquipped ? 'unequip-button' : 'equip-button'}`}
                            title={isEquipped ? 'Снять' : 'Экипировать'}> {isEquipped ? <UnequipIcon/> :
                        <EquipIcon/>} </button>)}
                {onDrop && (
                    <button onClick={handleDropClick} style={styles.actionButton} className="action-button drop-button"
                            title="Выбросить"><DropIcon/></button>)}
            </div>
...
const styles = {
    ...
    skillBonusTag: {
        color: theme.colors.success || '#81C784',
        borderColor: `${theme.colors.success || '#81C784'}44`,
        background: `${theme.colors.success || '#81C784'}1A`
    },
    // --- КОНЕЦ ---
    actionsContainer: {
        display: 'flex',
