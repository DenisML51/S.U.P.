...
const styles = {
    ...
    tabContentContainer: { flexGrow: 1, background: theme.effects.glass, backdropFilter: 'blur(10px)', borderRadius: '12px', padding: '25px', boxShadow: theme.effects.shadow, minHeight: '400px', position: 'relative', display: 'flex', flexDirection: 'column' },
